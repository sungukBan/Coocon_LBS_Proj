...
public class LbsSenderToSSServer extends Thread {
    ...
    public void createLbsSenderToSSServer() {
        try {
            m_serverSocket = new ServerSocket( Integer.parseInt(UtilCommon.getNullToStr(UtilConfig.getValue(ConstConfig.PORT_SS_SEND), "0")) );
        } catch (Exception e) {
        	UtilLogger.doLoggingException(UtilConfig.getValue(ConstConfig.LOG_PATH_ERR), e);
        }
    }
